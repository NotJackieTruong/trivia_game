...
import { Field, FieldError, FieldErrors, InternalFieldName, appendErrors, get, set } from 'react-hook-form';
...
export const yupResolver: Resolver =
  ...
  async (values, context, options) => {
    try {
      ...
      return {
        values: {},
        errors: toNestError(parseErrorSchema(e, options.criteriaMode === 'all'), options.fields)
      };
    }
  };
