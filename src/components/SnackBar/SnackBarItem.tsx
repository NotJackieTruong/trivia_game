import { BG_ERROR, BG_INFO, BG_SUCCESS, BG_WARN, DURATION_ANIMATED } from './constants';
...
const getColor = (typeMessage: TypeMessage, borderLeftColor: Omit<SnackBarItemProps, 'item' | 'onPop'>): string => {
  ...
  switch (typeMessage) {
    case 'success':
      return borderLeftColorSuccess || BG_SUCCESS;
    case 'info':
      return borderLeftColorInfo || BG_INFO;
    case 'warn':
      return borderLeftColorWarn || BG_WARN;
    case 'error':
      return borderLeftColorError || BG_ERROR;
    default:
      return borderLeftColorSuccess || BG_SUCCESS;
  }
};
