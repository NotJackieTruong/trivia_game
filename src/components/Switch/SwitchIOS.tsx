...
const SwitchComponent = ({ onToggle, initialValue = false, disable = false }: Omit<SwitchProps, 'type'>) => {
  // state
  ...
  const backgroundColor = useInterpolateColor(progress, [0, 1], [OFF_COLOR, ON_COLOR]);
