...
const TouchableScaleComponent = (props: TouchableScaleProps) => {
  // props
  const { children, minScale = 0.9, containerStyle: overwriteContainerStyle, onPressIn, onPressOut, ...rest } = props;
  ...
  // render
  return (
    <TouchableWithoutFeedback {...rest} onPressIn={_onPressIn} onPressOut={_onPressOut}>
      <Animated.View style={[styles.container, overwriteContainerStyle, containerAnimatedStyle]}>
        {children}
      </Animated.View>
