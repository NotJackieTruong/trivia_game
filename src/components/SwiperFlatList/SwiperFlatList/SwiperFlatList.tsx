...
const SwiperFlatList = React.forwardRef(
  (
    ...
    const [dimensions, setDimension] = React.useState(window);
    ...
    const flatListProps = {
      ...
      onScrollToIndexFailed: info => setTimeout(() => _scrollToIndex({ index: info.index, animated: false })),
      data: _data,
    ...
    return (
      <>
        ...
        />
        {showPagination && <PaginationComponent {...paginationProps} scrollX={scrollX} windowWidth={windowWidth} />}
      </>
    );
  }
);
