...
export type ValidationMap<T = any, Keys extends keyof T = keyof T> = { [K in Keys]-?: RegisterOptions };
...
export interface ChildProps extends Pick<FormProps, 'setValue' | 'getValues' | 'trigger' | 'errors'> {
  child: JSX.Element;
