...
const CollapsibleComponent = ({ renderContent, renderMasterView, children }: CollapsibleProps) => {
  // state
  ...
  const height = useDerivedValue(() => sharedTiming(isShow ? measured.height : 0));
  ...
  return (
    <View>
      <Animated.View pointerEvents="none" onLayout={_onLayoutContent} style={[styles.base, styles.hiddenView]}>
