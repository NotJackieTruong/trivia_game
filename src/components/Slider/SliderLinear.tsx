...
const SliderLinearComponent = ({
  ...
  const translateX = useDerivedValue(() =>
    sharedClamp(translationX.value, lowerBound - THUMB_SIZE, width - THUMB_SIZE)
  );
  // function
  ...
  // effect
  useEffect(() => {
    translationX.value = sharedSpring((initialLinear / upperBound) * width - THUMB_SIZE);
  ...
  useAnimatedReaction(
    () => parseFloat((((translateX.value + THUMB_SIZE) / width) * upperBound).toFixed(FIXED_AFTER)),
    result => {
